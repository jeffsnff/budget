...
const CONNECTION_URL = `mongodb+srv://${process.env.USERNAME}:${process.env.PASSWORD}@${process.env.DATABASE}.l42kn.mongodb.net/${process.env.COLLECTION}?retryWrites=true&w=majority`
